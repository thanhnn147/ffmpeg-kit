...
```
  ffmpeg_kit_flutter:
    git:
      url: https://github.com/thanhnn147/ffmpeg-kit.git
      ref: fix/v6.0.3
      path: flutter/flutter

```
Note: I followed guide here: https://medium.com/@ibrahimeltayfe/how-to-compile-ffmpeg-binaries-locally-for-flutter-android-ios-e66d2e109923
